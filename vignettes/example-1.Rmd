...
outpath <-file.path(Sys.getenv("USERPROFILE"),"Desktop")
create_ecs_input(input_shp, "line", outpath)
```
...
```{r}
file_out <- "rupture_vertices-usgs_qffd_nirc.csv"
result <-  read.csv(file.path(outpath, file_out))
names(result)
```
