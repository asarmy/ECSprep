#' Create ECS Ruptures Input File from Esri Shapefile
#'
#' Processes an Esri shapefile with line geometry for input to the Lavrentiadis
...
#'
#' @export
create_ecs_input_ruptures <- function(in_filepath, output_folder = NULL) {
